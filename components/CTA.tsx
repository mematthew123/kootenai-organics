...
const CTA: React.FC<CTAProps> = ({ initial, animate, transition }) => {
  return (
    <>
      ...
      >
        <div className='bg-[#f9f1e0] flex flex-col lg:flex-row items-center p-4 lg:p-10 space-y-4 lg:space-y-0 lg:space-x-4 lg:w-[1100px] max-w-full mx-auto mb-20 rounded-md shadow-lg border border-gray-200'>
