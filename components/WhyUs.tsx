...
import SectionLeft from "@/animations/sectionLeft";
...
const WhyUs = () => {
  return (
    <div className='container mt-20 lg:mt-40 mx-auto space-y-20 py-10 bg-[#696B33] px-4 rounded-lg shadow-lg border border-gray-200'>
      <div className='  text-center space-y-10'>
        <SectionLeft>
          <h2
            className={
              inter.className +
              " text-4xl lg:text-5xl font-bold leading-loose p-6 text-[#FBF4E2]"
            }
          >
            Why Choose Us?
          </h2>
