            ...
            >
              ...
              <Link href='/menu'>
                <p
                  className={
                    poppins.className +
                    "inline-block leading-loose text-center bg-[#696B33] text-[#f0ead6] px-4 py-2 rounded-lg hover:bg-[#183B47] transition-colors duration-200 shadow-md hover:shadow-lg lg:mb-6 mt-10 mb-2 my-3"
                  }
                >
                  Buy Now
                </p>
