...
const Featured: React.FC<{ featuredData: FeaturedData }> = ({
  ...
  return (
    <>
      <div className='bg-[#CD8B2A] mt-20 lg:mt-40 flex flex-col lg:flex-row p-4 lg:p-10 space-y-4 lg:space-y-0 lg:space-x-4 lg:max-w-7xl mx-auto my-20 rounded-lg shadow-lg border '>
          ...
          >
            ...
            <Link href='/menu'>
              <p
                className={
                  poppins.className +
                  "inline-block leading-loose text-center bg-[#696B33] text-[#f0ead6] px-4 py-2 rounded-lg hover:bg-green-700 transition-colors duration-200 shadow-md hover:shadow-lg lg:mb-6 mt-10 mb-2 my-3"
                }
              >
                Buy Now
              </p>
